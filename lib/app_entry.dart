...
import 'package:crop_care_app/core/firebase_options.dart';
...
import 'package:crop_care_app/presentation/providers/locale_provider.dart';
import 'package:crop_care_app/presentation/screens/onboarding_screen.dart';
import 'package:crop_care_app/presentation/screens/splash_screen.dart';
...
Future<void> _initializeApp(
  WidgetRef ref,
  dynamic initializationProvider,
) async {
...
class _MyAppState extends ConsumerState<MyApp> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _initializeApp(ref, initializationProvider);
    });
  }
